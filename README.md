...
![Critical](https://img.shields.io/badge/Critical-21-FF3B5C?style=for-the-badge&labelColor=1a0008)
![High](https://img.shields.io/badge/High-36-FF7C2A?style=for-the-badge&labelColor=1a0800)
![Medium](https://img.shields.io/badge/Medium-38-F5C518?style=for-the-badge&labelColor=1a1400)
![Low](https://img.shields.io/badge/Low-13-4ADE80?style=for-the-badge&labelColor=001a08)
![Informational](https://img.shields.io/badge/Info-11-60A5FA?style=for-the-badge&labelColor=00081a)
![Total](https://img.shields.io/badge/Total-119-00C8FF?style=for-the-badge&labelColor=001219)

| Severity | Metasploitable 2 | VulnWeb App | Combined Total |
|----------|:---------------:|:-----------:|:--------------:|
| ![Critical](https://img.shields.io/badge/Critical-FF3B5C?style=flat-square) | 19 | 2 | **21** |
| ![High](https://img.shields.io/badge/High-FF7C2A?style=flat-square) | 33 | 3 | **36** |
| ![Medium](https://img.shields.io/badge/Medium-F5C518?style=flat-square&logoColor=000) | 34 | 4 | **38** |
| ![Low](https://img.shields.io/badge/Low-4ADE80?style=flat-square&logoColor=000) | 9 | 4 | **13** |
| ![Info](https://img.shields.io/badge/Info-60A5FA?style=flat-square) | 6 | 5 | **11** |
| **Total** | **101** | **18** | **119** |
...
Aligned with **NIST SP 800-115** and the **OWASP Testing Guide v4.2**:
...
/
├── README.md
├── AFS-Presentation-Slides.pdf         
├── AFS_SOC_VulnMgmt_Report.docx        
└── vuln-scans-reports/
    ├── Metasploitable 2/
    └── VulnWeb PHP App/
```

> The [`vuln-scans-reports/`](https://github.com/AtejiEmmanuel/afs-soc-vuln-management/tree/main/vuln-scans-reports) folder contains the raw scan outputs referenced as Appendix B in the main report.

---

## Remediation Summary

The report includes a full prioritised remediation roadmap. Top immediate actions ![<24hrs](https://img.shields.io/badge/%3C_24_hours-URGENT-FF3B5C?style=flat-square):
